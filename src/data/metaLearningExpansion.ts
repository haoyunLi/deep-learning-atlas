...
export const metaLearningExpansionLessons: Lesson[] = [
  {
    ...
    title: "Episodic Meta-Learning：划分 Support Set 与 Query Set",
    ...
    intuition:
      "普通训练一次抽一个 Batch；Meta-Learning 一次抽一个 Task。Support Set 像开卷材料，Query Set 像看完材料后的考试。真正要验证的是面对 Unseen Task 能否快速学会。",
  ...
  },
  {
    ...
    whenToUse: [
      ...
      "需要 No-Gradient Test-Time Adaptation，并想和 ProtoNet 比较时。",
    ],
    limits: [
  ...
  },
  {
    ...
    title: "Relation Networks：把距离函数也学出来",
  ...
  },
  {
    ...
    title: "Siamese Networks 与 Triplet Loss：先学会比较",
  ...
  },
  {
    ...
    title: "Hypernetworks 与 Meta-Gradient：参数也可以由模型产生",
    ...
    settings: [
      ...
      },
      {
        ...
        adjust:
          "Inner Loop 很长时再用 Truncated 或 Implicit Gradient，并比较偏差。",
      },
    ],
    modifications: [
  ...
  },
  {
    ...
    howToUse: [
      ...
      "做 Support Set 大小、Backbone 层解冻与 Data Augmentation 的 Domain-Level Ablation。",
    ],
    tuning: [
  ...
  },
  {
    ...
    title: "Transfer Learning：Freeze、Fine-Tune 还是 Train from Scratch",
  ...
  },
  {
    ...
    modifications: [
      ...
      "结合 Pseudo-Label 时只使用高置信且校准的 Target 样本。",
    ],
    pitfalls: [
  ...
  },
  {
    ...
    title: "Continual Learning：在学新任务时别忘旧任务",
  ...
  },
  {
    ...
    title: "Active Learning：下一笔标注花在哪里",
  ...
  },
  {
    ...
    title: "Multi-Task Learning：共享什么，冲突怎么办",
  ...
  },
  {
    ...
    title: "AutoML：HPO、Hypergradient 与 NAS",
  ...
  },
  {
    ...
    title: "Federated Learning 与 FedAvg：数据不集中时怎样共同训练",
  ...
  },
  {
    ...
    title: "Test-Time Adaptation 与 TENT：模型上线后还能改什么",
  ...
  },
  {
    ...
    title: "Semi-Supervised Learning 与 Self-Training：使用无标签数据",
